...
export function ClosingBanner() {
  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-20 sm:py-24 overflow-hidden">
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 -z-10 h-[350px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/10 blur-[140px]" />

      <Reveal>
        <div className="relative overflow-hidden rounded-[2.5rem] border border-primary/30 bg-slate-900/90 px-6 py-16 text-center shadow-[0_0_50px_rgba(16,185,129,0.15)] backdrop-blur-2xl sm:px-12 sm:py-20">
          ...
          <p className="mx-auto mt-5 max-w-xl text-slate-300 text-sm sm:text-base leading-relaxed text-pretty">
          ...
          <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-4">
            <motion.a
              ...
              className="group inline-flex items-center justify-center gap-3 rounded-full bg-primary px-9 py-4 text-base font-black text-slate-950 shadow-[0_0_30px_rgba(16,185,129,0.4)] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(16,185,129,0.6)] active:scale-95"
            >
